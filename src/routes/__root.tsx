  ...
  head: () => ({
    meta: [
      ...
      { title: "Poshala Navateja" },
      {
        name: "description",
        content:
          "Portfolio of a software engineer building AI-native tools, agentic systems, and applied ML models ready to deliver scalable software solutions.",
      },
    ...
    links: [
      ...
      { rel: "icon", href: "/favicon.ico", sizes: "48x48 96x96 144x144 192x192" },
    ...
    scripts: [
      {
        async: true,
        src: "https://www.googletagmanager.com/gtag/js?id=G-QE5E3R436X",
      },
      {
        children: `window.dataLayer = window.dataLayer || [];\nfunction gtag(){dataLayer.push(arguments);}\ngtag('js', new Date());\ngtag('config', 'G-QE5E3R436X');`,
      },
    ],
  }),
